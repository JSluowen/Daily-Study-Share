...
- [实现 Users Reducer](http://scriptoj.com/problems/16)



[下一节：动手实现 React-redux（一）：初始化工程](http://huziketang.mangojuice.top/books/react/lesson36)



[上一节：动手实现 Redux（五）：不要问为什么的 reducer](http://huziketang.mangojuice.top/books/react/lesson34)