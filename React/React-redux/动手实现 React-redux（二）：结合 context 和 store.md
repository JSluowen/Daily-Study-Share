...
[下一节：动手实现 React-redux（三）：connect 和 mapStateToProps](http://huziketang.mangojuice.top/books/react/lesson38)



[上一节：动手实现 React-redux（一）：初始化工程](http://huziketang.mangojuice.top/books/react/lesson36)