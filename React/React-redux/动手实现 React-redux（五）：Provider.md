...
[下一节：动手实现 React-redux（六）：React-redux 总结](http://huziketang.mangojuice.top/books/react/lesson41)

[上一节：动手实现 React-redux（四）：mapDispatchToProps](http://huziketang.mangojuice.top/books/react/lesson39)