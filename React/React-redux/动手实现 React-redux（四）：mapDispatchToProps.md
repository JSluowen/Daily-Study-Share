...
[下一节：动手实现 React-redux（五）：Provider](http://huziketang.mangojuice.top/books/react/lesson40)

[上一节：动手实现 React-redux（三）：connect 和 mapStateToProps](http://huziketang.mangojuice.top/books/react/lesson38)